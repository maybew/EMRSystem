...
Calendar.prototype.draw = function() {   
  ...
  if("d" == this.type){
    ...
    lis += "<li style='width:30%;'><span class='selectThisYear'>" + this.date.getFullYear() + "</span>&nbsp;" + Calendar.language["title"][this.lang][0] + "</li>";
  	if(0 == this.lang){
  		lis += "<li style='width:20%;'><span class='selectThisMonth'>" + Calendar.language["months"][this.lang][this.date.getMonth()] + "</span></li>";
  	}else{
  		lis += "<li style='width:20%;'><span class='selectThisMonth'>" + (this.date.getMonth() +1) + "</span>&nbsp;" + Calendar.language["title"][this.lang][1] + "</li>";
  	}
	...
	lis += "<li id='selectCurrent' style='width:45%;' title='Today'>" + Calendar.language.today[this.lang][0] +"</li>";
  	...
  	lis += "<li style='width:74%;'><span class='selectThisYear'>" + this.date.getFullYear() + "</span>&nbsp;" + Calendar.language["title"][this.lang][0] + "</li>";
  	lis += "<li id='NextYear' class='mark' style='width:12%;' title='Next Year'>&raquo;</li></ul></div>";
  	lis += "<div class='calendarBody'>";
